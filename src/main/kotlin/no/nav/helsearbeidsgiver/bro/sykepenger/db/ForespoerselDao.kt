...
class ForespoerselDao(private val dataSource: DataSource) {
    ...
    fun hentForespoerselForForespoerselId(forespoerselId: UUID, statuser: Set<Status>): ForespoerselDto? =
    ...
    private fun hentForespoerselForVedtaksperiodeId(vedtaksperiodeId: UUID, statuser: Set<Status>): List<ForespoerselDto> =
        query(
